...
- (void)drawInContext:(CGContextRef)ctx
{
	...
	[_caption drawInRect:f withAttributes:@{ NSFontAttributeName : font, NSParagraphStyleAttributeName : paragraphStyle, NSForegroundColorAttributeName : [UIColor blackColor]}];	// DFH
